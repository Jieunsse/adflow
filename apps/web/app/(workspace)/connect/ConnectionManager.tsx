...
export function ConnectionManager({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <div className={embedded ? "flex flex-col gap-7" : "px-12 py-9 pb-16 max-w-[1280px] w-full mx-auto flex flex-col gap-7"} data-screen-label="연결 관리">
      {!embedded && <div className="flex justify-between items-end gap-6">
        <div>
