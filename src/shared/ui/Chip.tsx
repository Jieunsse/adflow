...
const VARIANT: Record<ChipVariant, string> = {
  ...
  ended:          "bg-[rgba(112,115,124,0.10)] text-[var(--w-fg-neutral)] dark:bg-[rgba(255,255,255,0.08)]",
  issue:          "bg-[#feecec] text-[#b20c0c] dark:bg-[rgba(255,66,66,0.16)] dark:text-[#ff7a7a]",
  neutral:        "bg-[rgba(112,115,124,0.08)] text-[var(--w-fg-strong)] dark:bg-[rgba(255,255,255,0.06)]",
  "obj-traffic":  "bg-[rgba(0,102,255,0.10)] text-[var(--w-primary-press)] dark:bg-[rgba(0,102,255,0.20)] dark:text-[#6ea7ff]",
  "obj-conversion":"bg-[var(--w-accent-violet-soft)] text-[var(--w-accent-violet)] dark:bg-[rgba(101,65,242,0.22)] dark:text-[#b9a4ff]",
